    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-300px py-3"
        ...
        <div class="row g-3 px-3 mb-3">
            <div class="col-md-12">
                ...
                <input type="range" id="temperature" name="temperature" class="form-range" min="0"
                    max="2" step="0.1" value="{{ $conversation->configuration->temperature ?? 0.7 }}">
                <small class="text-gray-600">Current: <span
                        id="temp-display">{{ $conversation->configuration->temperature ?? 0.7 }}</span></small>
            </div>
            <div class="separator my-4"></div>
            <div class="col-md-12">
                <label class="form-label">Max Tokens</label>
                <input type="number" id="max_tokens" name="max_tokens" class="form-control form-control-solid"
                    min="1" max="4000" value="{{ $conversation->configuration->max_tokens ?? 2000 }}"
                    placeholder="2000">
            </div>
            <div class="separator my-4"></div>
            <div class="col-md-12">
                <label class="form-label">Context Limit</label>
                <select id="context_limit" name="context_limit" class="form-select form-select-solid form-select-xs"
