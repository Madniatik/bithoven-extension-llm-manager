    ...
    <div class="card-header" id="kt_chat_messenger_header">
        ...
        <div class="card-title">
            ...
            <div class="symbol-group symbol-hover">
                ...
                <!--begin::Avatar-->
                <div class="symbol symbol-35px symbol-circle">
                    <img alt="Pic" src="{{ metronicAsset('media/avatars/300-25.jpg') }}" />
                </div>
                <!--end::Avatar-->
                <!--begin::Avatar-->
                <div class="symbol symbol-35px symbol-circle">
                ...
                <!--begin::Avatar-->
                <div class="symbol symbol-35px symbol-circle">
                    <img alt="Pic" src="{{ metronicAsset('media/avatars/300-9.jpg') }}" />
                </div>
                <!--end::Avatar-->
                <!--begin::Avatar-->
                <div class="symbol symbol-35px symbol-circle">
                ...
                <!--begin::Avatar-->
                <div class="symbol symbol-35px symbol-circle">
                    <img alt="Pic" src="{{ metronicAsset('media/avatars/300-23.jpg') }}" />
                </div>
                <!--end::Avatar-->
                <!--begin::All users-->
            ...
            <div class="d-flex justify-content-end mb-10">
                ...
                <div class="d-flex flex-column align-items-end">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <!--begin::Avatar-->
                        <div class="symbol symbol-35px symbol-circle">
                            <img alt="Pic" src="{{ metronicAsset('media/avatars/300-1.jpg') }}" />
                        </div>
                        <!--end::Avatar-->
                    </div>
                    <!--end::User-->
