        ...
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <div class="form-check form-switch form-check-custom form-check-solid">
                    <input class="form-check-input" type="checkbox" id="unlock-advanced"
                        onchange="toggleAdvancedLock(this.checked)" />
            ...
            <form id="advanced-settings-form">
                ...
                <div
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        ...
                        <span>These settings override provider defaults. Incorrect values may cause connection failures.
                            Leave empty to use defaults.</span>
                    </div>
                </div>
                <!--end::Alert-->
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="url" name="api_endpoint" id="api_endpoint"
                            ...
                            value="{{ $model->api_endpoint }}" disabled />
                        <div class="form-text">
                ...
                <div class="row mb-7">
                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                        ...
                        <span class="ms-1" data-bs-toggle="tooltip"
                            title="Override the chat/completions endpoint path">
                            <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                <span class="path1"></span>
                                <span class="path2"></span>
                                <span class="path3"></span>
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="endpoint_chat" id="endpoint_chat"
                            ...
                            value="{{ $model->endpoint_chat }}" disabled />
                        <div class="form-text">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="endpoint_embeddings" id="endpoint_embeddings"
                            ...
                            value="{{ $model->endpoint_embeddings }}" disabled />
                        <div class="form-text">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="endpoint_models" id="endpoint_models"
                            ...
                            value="{{ $model->endpoint_models }}" disabled />
                        <div class="form-text">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 fv-row">
                        <textarea name="custom_headers" id="custom_headers" rows="4"
                            class="form-control form-control-lg form-control-solid advanced-field" placeholder='{"X-Custom-Header": "value"}'
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="number" name="timeout" id="timeout"
                            class="form-control form-control-lg form-control-solid advanced-field" placeholder="30"
                            value="{{ $model->timeout }}" min="5" max="300" disabled />
                        <div class="form-text">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="number" name="retry_attempts" id="retry_attempts"
                            class="form-control form-control-lg form-control-solid advanced-field" placeholder="3"
                            value="{{ $model->retry_attempts }}" min="0" max="10" disabled />
                        <div class="form-text">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <button type="button" id="save-advanced-btn" class="btn btn-warning"
                            onclick="saveAdvancedSettings()" disabled>
                        ...
                        <button type="button" class="btn btn-light-danger ms-3" onclick="resetAdvancedSettings()"
                            id="reset-advanced-btn" disabled>
...
@push('scripts')
    <script>
        ...
        function saveAdvancedSettings() {
            ...
            const fields = ['api_endpoint', 'endpoint_chat', 'endpoint_embeddings', 'endpoint_models', 'custom_headers',
                    ...
                    fetch("{{ route('admin.llm.models.update-advanced', $model) }}", {
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                Monitor.error('llm-monitor', data.message ||
