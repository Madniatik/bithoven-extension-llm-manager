...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('llm_manager_parameter_overrides', function (Blueprint $table) {
            ...
            $table->foreignId('llm_provider_configuration_id')->nullable()->constrained('llm_manager_provider_configurations', indexName: 'llm_po_config_fk')->onDelete('cascade');
            ...
            $table->index(['llm_provider_configuration_id', 'is_active'], 'llm_po_cfg_active_idx');
